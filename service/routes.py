...
def list_customers():
    ...
    postalcode = request.args.get("address.postalcode")
    ...
    if email:
        ...
        customers =Customer.find_by_postalcode(address.postalcode)
    elif street:
        customers =Customer.find_by_street(address.street)
    else:
